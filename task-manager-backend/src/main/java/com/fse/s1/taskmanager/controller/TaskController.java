...
import com.fse.s1.taskmanager.service.ITaskService;
...
public class TaskController {
	 ...
	 * @return
	 */
	@RequestMapping(value="/tasks/filtered", method=RequestMethod.PUT, produces="application/json")
	...
	public ResponseEntity<Task> addTaskDetails(@RequestBody Task task) throws URISyntaxException{
